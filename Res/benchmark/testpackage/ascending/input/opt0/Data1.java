package testpackage.ascending.input.opt0;
/************************************************************************
...
public class Data1 extends CobolBean {
	...
	public String getDummyElement() {
		return super.toString(0,100);
	}
	public  void setDummyElement(String val) {
		super.valueOf(0,100,val);
	}
	...
	public byte[] getElement(int idx1) {
		return super.getBytes(100+45*--idx1,45);
	}
	public  void setElement(byte[] val,int idx1) {
		super.valueOf(100+45*--idx1,45,val,0);;
	}
	//@CobolSourceFile("SORT-ELEMENT3.CPY",2,15) 
	//05 ELEMENT1 PIC S9(12) .
	public long getElement1(int idx1) {
		return super.getDisplayLong(100+45*--idx1,13,true,false,false);
	}
	public  void setElement1(long val,int idx1) {
		super.setDisplayLong(100+45*--idx1,13,val,true,false,false);
	}
	...
	public long getElement2(int idx1) {
		return super.getDisplayLong(100+45*--idx1+13,13,true,false,false);
	}
	public  void setElement2(long val,int idx1) {
		super.setDisplayLong(100+45*--idx1+13,13,val,true,false,false);
	}
	...
	public byte[] getBytes() {
		...
		bytes_.valueOf(0,100,super.toString(0,100));
		bytes_.valueOf(100,460800,super.getBytes(100,460800),0);;
		return bytes_.getBytes();
	}
	public void valueOf(byte[] val) {
		CobolBytes bytes_=new CobolBytes(val,460900);
		super.valueOf(0,100,bytes_.toString(0,100));
		super.valueOf(100,460800,bytes_.getBytes(100,460800),0);;
	}
}
