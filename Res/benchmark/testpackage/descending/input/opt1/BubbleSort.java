package testpackage.descending.input.opt1;
/************************************************************************
 ...
 ************************************************************************/
import testpackage.descending.input.opt1.Data1;
import testpackage.descending.input.opt1.TempElement;
...
public class BubbleSort extends Program {
	...
	public  void setCount1(long val) {
		count1=super.normalizeBinary(val,12,false);
	}
	...
	public  void setTemp1(long val) {
		temp1=super.normalizeBinary(val,12,false);
	}
	...
	public  void setTemp2(long val) {
		temp2=super.normalizeBinary(val,12,false);
	}
	...
	public  void setTemp3(long val) {
		temp3=super.normalizeBinary(val,12,false);
	}
	...
	public  void setBegin(long val) {
		begin=super.normalizeBinary(val,12,false);
	}
	...
	public  void setFinish(long val) {
		finish=super.normalizeBinary(val,12,false);
	}
